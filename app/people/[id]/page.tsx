        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold">Email Conversations</h2>
              <Link
                href={`/people/${person.id}/conversations`}
            ...
            <div className="text-center py-4">
              ...
              <p className="text-sm text-gray-600 mb-2">Track email conversations</p>
              <p className="text-xs text-gray-500">
                BCC <code className="bg-gray-100 px-1 rounded">track@yourmission.org</code>
              </p>
            </div>
          </div>
