...
export function AddFieldForm({ sectionId }: AddFieldFormProps) {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : 'Failed to create field')
    } finally {
        ...
        <form action={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., birth_date, company_size"
            />
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="e.g., Birth Date, Company Size"
            />
